...
namespace RegistroOngApp
{
    public class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            // Controles de Nombre
            Label lblNombre = new Label() { Text = "Nombre completo:", Location = new Point(20, 20), AutoSize = true };
            txtNombre = new TextBox() { Location = new Point(20, 45), Width = 280 };

            // Controles de Rol
            Label lblRol = new Label() { Text = "Rol:", Location = new Point(20, 80), AutoSize = true };
            cmbRol = new ComboBox() { Location = new Point(20, 105), Width = 280, DropDownStyle = ComboBoxStyle.DropDownList };
            cmbRol.Items.AddRange(new string[] { "Voluntario", "Coordinador" });
            cmbRol.SelectedIndex = 0;

            // Botón de Acción
            btnGuardar = new Button() { Text = "Guardar Registro", Location = new Point(20, 150), Width = 280, BackColor = Color.LightGreen };
